...
- (void)viewDidLoad
{
    ...
    [[DataManager sharedInstance] loadPizzaPlaces];
}
...
{
    PizzaPlace *place = [[DataManager sharedInstance] pizzaPlaceAtIndexPath:indexPath];
    cell.textLabel.text = [NSString stringWithFormat:@"%@, %@", place.name, place.distance];
}
